  ...
  return (
    <>
      ...
      >
        <div className="flex flex-col lg:flex-row justify-between items-center gap-8">
          <div className="flex flex-col justify-center items-start gap-4 w-full">
            ...
            <div>
              <Button className="rounded-none text-xs font-extrabold group">
                Start Now{" "}
                <ChevronRight
      ...
      <section className="section py-8! flex flex-col justify-center items-center gap-8">
        ...
        <Carousel className="max-w-60 md:max-w-full">
          <CarouselContent>
        ...
        <div className="flex flex-col justify-center items-center gap-8">
          <div className="flex flex-col justify-center items-center gap-2">
            ...
            <p className="text-center text-xs text-muted-foreground max-w-5xl">
              ...
              designed to teach essential safety skills in a clear and engaging
              way. Each course focuses on real-world scenarios, guiding you
              through what to do before, during, and after emergencies. With
              interactive lessons, hands-on games, and short assessments, our
              courses help you build confidence, improve awareness, and stay
              prepared when it matters most.
            </p>
          </div>
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 w-full gap-4">
            <Link href={"/course/flood"}>
              <Card className="hover:border-emerald-600 group h-full">
                ...
                <CardContent>
                  <p className="text-xs text-muted-foreground">
                    ...
                    evacuation steps, and post-flood safety measures to help you
                    reduce risk and protect yourself and others.
                  </p>
                </CardContent>
