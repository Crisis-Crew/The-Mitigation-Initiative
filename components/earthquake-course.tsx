            ...
            >
              ...
              <div className="relative z-10 p-6 lg:p-12 space-y-4">
                ...
                <p className="text-sm leading-tight text-muted-foreground max-w-2xl">
                  ...
                  movements within the Earth’s crust. These movements release
                  energy that can damage buildings, roads, and infrastructure,
                  often without warning.
                  <br />
                  <br />
                  This quiz tests your understanding of essential earthquake
                  safety measures — what actions to take during shaking, how to
                  protect yourself indoors and outdoors, and what precautions to
                  follow after the shaking stops — helping you stay alert, act
                  safely, and reduce the risk of injury during an earthquake.
                </p>
              </div>
            </div>
          </section>
