...
import makeEarthquake from "@/levels/earthquake/main";
import levelOne from "@/levels/earthquake/levelone";
  ...
  useEffect(() => {
    if (gameContainerRef.current && certificateContainerRef.current) {
      ...
      k.loadSprite(
        ...
        "/assets/backgrounds/earthquake.png",
      );

      k.loadSprite("Start", "/assets/sprites/start.png");
      k.loadSprite("Restart", "/assets/sprites/restart.png");
      k.loadSprite("Button", "/assets/sprites/Button2_05.png");
      k.loadSprite("Play", "/assets/sprites/Icon_34.png");
      k.loadSprite("Road", "/assets/sprites/road.png");
      ...
      k.loadSprite("Explosion", "/assets/sprites/Explosion.png", {
        sliceY: 1,
        sliceX: 8,
        anims: {
          explode: {
      ...
      k.loadSprite("tile000", "/assets/sprites/tile000.png");
      k.loadSprite("tile001", "/assets/sprites/tile001.png");
