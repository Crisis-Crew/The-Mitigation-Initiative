            ...
            >
              ...
              <div className="relative z-10 p-6 lg:p-12 space-y-4">
                ...
                <p className="text-sm leading-tight text-muted-foreground max-w-2xl">
                  ...
                  submerges land that is usually dry. This can happen due to
                  heavy rainfall, overflowing rivers, dam failures, or coastal
                  storms.
                  <br />
                  <br />
                  This quiz tests your understanding of essential flood safety
                  measures — what to do before, during, and after a flood —
                  helping you stay prepared and reduce risk during emergencies.
                </p>
              </div>
            </div>
          </section>
