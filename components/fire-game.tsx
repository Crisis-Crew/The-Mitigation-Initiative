...
import levelOne from "@/levels/fire/levelone";
import Image from "next/image";
import QRCode from "react-qr-code";
import makeFire from "@/levels/fire/main";
...
export default function FireGame({ user }: { user: User | undefined }) {
  ...
  useEffect(() => {
    if (
      ...
      k.loadSprite("Fire Background", "/assets/backgrounds/fire.png");
      ...
      k.loadSprite("Fire Flames", "/assets/backgrounds/fire_flames.png");
      ...
      k.loadSprite("Doors", "/assets/sprites/doors.png", {
        sliceX: 1,
        sliceY: 10,
        anims: {
          move: {
